...
if (isset($_SESSION['username'])) {
    ...
    $keahlian = mysqli_query($con, "DELETE FROM t_keahlian WHERE DATEDIFF(CURDATE(), tgl_input) > $lama");
    $tkepalakeluarga = mysqli_query($con, "DELETE FROM t_kepalakeluarga WHERE DATEDIFF(CURDATE(), tgl_input) > $lama");
    $tmasakkerja = mysqli_query($con, "DELETE FROM t_masakkerja WHERE DATEDIFF(CURDATE(), tgl_input) > $lama");
    $reward = mysqli_query($con, "DELETE FROM reward WHERE DATEDIFF(CURDATE(), tgl_input) > $lama");
    $lembur = mysqli_query($con, "DELETE FROM lembur WHERE DATEDIFF(CURDATE(), tgl_input) > $lama");
    $cicilan = mysqli_query($con, "DELETE FROM cicilan WHERE DATEDIFF(CURDATE(), tgl_input) > $lama");
    $gaji = mysqli_query($con, "DELETE FROM gaji WHERE DATEDIFF(CURDATE(), tgl_pembayaran) > $lama");
    $ttp = mysqli_query($con, "DELETE FROM tunjangan_tidak_tetap WHERE DATEDIFF(CURDATE(), tgl_input) > $lama");
    // 
?>
    <!-- Begin Page Content -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (mysqli_num_rows($Sqlcek) > 1) {
                                                $Sqltotal = mysqli_query($con, "SELECT SUM(jumlah_tunjangan_keahlian) as total FROM t_keahlian WHERE nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                        ...
                                        <td>
                                            <?php
                                            $Sqlcek = mysqli_query($con, "SELECT * FROM dt_karyawan as k INNER JOIN t_kepalakeluarga as tk ON k.nip = tk.nip where k.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                        ...
                                        <td>
                                            <?php
                                            $Sqlcek = mysqli_query($con, "SELECT * FROM dt_karyawan as k INNER JOIN t_masakkerja as tk ON k.nip = tk.nip where k.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            if (mysqli_num_rows($Sqlcek) > 0) {
                                                $total = mysqli_fetch_array($Sqlcek);
                                        ...
                                        <td>
                                            <?php
                                            $Sqlcek = mysqli_query($con, "SELECT * FROM dt_karyawan as k INNER JOIN reward as tk ON k.nip = tk.nip where k.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            if (mysqli_num_rows($Sqlcek) > 0) {
                                                $total = mysqli_fetch_array($Sqlcek);
                                        ...
                                        <td>
                                            <?php
                                            $Sqlcek = mysqli_query($con, "SELECT * FROM dt_karyawan as k INNER JOIN lembur as tk ON k.nip = tk.nip where k.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            if (mysqli_num_rows($Sqlcek) > 0) {
                                                $total = mysqli_fetch_array($Sqlcek);
                                        ...
                                        <td>
                                            <?php
                                            $Sqlcek = mysqli_query($con, "SELECT * FROM dt_karyawan as k INNER JOIN infaq as tk ON k.nip = tk.nip where k.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            if (mysqli_num_rows($Sqlcek) > 0) {
                                                $total = mysqli_fetch_array($Sqlcek);
                                        ...
                                        <td>
                                            <?php
                                            $Sqlcek = mysqli_query($con, "SELECT * FROM dt_karyawan as k INNER JOIN cicilan as tk ON k.nip = tk.nip where k.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            if (mysqli_num_rows($Sqlcek) > 0) {
                                                $total = mysqli_fetch_array($Sqlcek);
                                        ...
                                        <td>
                                            <!-- perhitungan -->
                                            <?php
                                            $Sqlkeahlian = mysqli_query($con, "SELECT SUM(jumlah_tunjangan_keahlian) as jumlah FROM `t_keahlian` as t inner join dt_karyawan as d on t.nip = d.nip WHERE t.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "' ");
                                            ...
                                            $Sqltunjangankepalakeluarga = mysqli_query($con, "SELECT * FROM `t_kepalakeluarga` as t inner join dt_karyawan as d on t.nip = d.nip WHERE t.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            ...
                                            $Sqltunjanganmasakerja = mysqli_query($con, "SELECT * FROM `t_masakkerja` as t inner join dt_karyawan as d on t.nip = d.nip WHERE t.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            ...
                                            $Sqlreward = mysqli_query($con, "SELECT * FROM `reward` as t inner join dt_karyawan as d on t.nip = d.nip WHERE t.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            ...
                                            $Sqllembur = mysqli_query($con, "SELECT * FROM `lembur` as t inner join dt_karyawan as d on t.nip = d.nip WHERE t.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            ...
                                            $Sqlcicilan = mysqli_query($con, "SELECT * FROM `cicilan` as t inner join dt_karyawan as d on t.nip = d.nip WHERE t.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
                                            ...
                                            $Sqlinfaq = mysqli_query($con, "SELECT * FROM `infaq` as t inner join dt_karyawan as d on t.nip = d.nip WHERE t.nip = '$nip' && MONTH(tgl_input) = '" . $bln . "'");
